    ...
    const addCart_ = id => {
        ...
        dispatch(updateCart(data))
            .then(response => {
                ...
                setMessage("The product was add to cart successfully!");
            })
            .catch(e => {
                console.log(e);
            });
      ...
      <section className="text-gray-700 body-font overflow-hidden bg-white">
        ...
        <div className="container px-5 py-24 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
                <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={ currentProduct.image }/>
                <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    <h2 className="text-sm title-font text-gray-500 tracking-widest">{ currentProduct.category }  </h2>
                    ...
                    <div className="flex mb-4">
                        <span className="flex items-center">
                            ...
                            <span className="text-gray-600 ml-3">{ currentProduct.rating.rate } Reviews</span>
                        </span>
                    ...
                    <div className="flex">
                        ...
                        <button className="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded" onClick={() => addCart_(currentProduct.id)}>Add to Cart</button>
                    ...
                    <span className="title-font font-medium text-2xl text-lime-500">{message}</span>
                </div>
            </div>
        </div>
        ) : (
